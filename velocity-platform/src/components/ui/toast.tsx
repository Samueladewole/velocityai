...
const EnhancedToast = React.forwardRef<
  ...
  EnhancedToastProps
>(({ title, description, variant, action, ...props }, ref) => {
  const icons = {
    default: Info,
