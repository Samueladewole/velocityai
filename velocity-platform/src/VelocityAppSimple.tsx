      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/velocity/creator" element={
            <ProtectedRoute>
              <ComingSoon title="Agent Creator" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/scheduled" element={
            <ProtectedRoute>
              <ComingSoon title="Scheduled Tasks" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/logs" element={
            <ProtectedRoute>
              <ComingSoon title="Agent Logs" />
            </ProtectedRoute>
          } />
          
          {/* QIE Routes - Key Velocity Differentiator */}
          <Route path="/velocity/qie" element={
            <ProtectedRoute>
              <QIEPage />
            </ProtectedRoute>
          } />
          <Route path="/velocity/qie/workflow" element={
            <ProtectedRoute>
              <QIEWorkflowPage />
            </ProtectedRoute>
          } />
          
          {/* ISACA Digital Trust Routes - Enterprise Credibility */}
          <Route path="/velocity/isaca/cobit" element={
            <ProtectedRoute>
              <ISACADigitalTrustPage />
            </ProtectedRoute>
          } />
          <Route path="/velocity/isaca/riskit" element={
            <ProtectedRoute>
              <ComingSoon title="Risk IT Framework" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/isaca/trust" element={
            <ProtectedRoute>
              <ISACADigitalTrustPage />
            </ProtectedRoute>
          } />
          <Route path="/velocity/isaca/maturity" element={
            <ProtectedRoute>
              <ISACADigitalTrustPage />
            </ProtectedRoute>
          } />
          ...
          {/* Evidence Routes */}
          <Route path="/velocity/validation" element={
            <ProtectedRoute>
              <ComingSoon title="Validation Queue" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/export" element={
            <ProtectedRoute>
              <ComingSoon title="Export Center" />
            </ProtectedRoute>
          } />
          ...
          <Route path="/velocity/trust-score" element={
            <ProtectedRoute>
              <ComingSoon title="Trust Score" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/compliance/soc2" element={
            <ProtectedRoute>
              <ComingSoon title="SOC 2 Compliance" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/compliance/iso27001" element={
            <ProtectedRoute>
              <ComingSoon title="ISO 27001 Compliance" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/compliance/gdpr" element={
            <ProtectedRoute>
              <ComingSoon title="GDPR Compliance" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/compliance/custom" element={
            <ProtectedRoute>
              <ComingSoon title="Custom Frameworks" />
            </ProtectedRoute>
          } />

          {/* Observability Routes - Enterprise AI Transparency */}
          <Route path="/velocity/observability/executive" element={
            <ProtectedRoute>
              <ObservabilityExecutiveWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/observability/operational" element={
            <ProtectedRoute>
              <ObservabilityOperationalWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/observability/agents" element={
            <ProtectedRoute>
              <ComingSoon title="AI Agent Performance" description="Detailed AI agent monitoring and performance analytics" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/observability/compliance" element={
            <ProtectedRoute>
              <ComingSoon title="Compliance Tracking" description="Real-time compliance monitoring and tracking" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/observability/audit" element={
            <ProtectedRoute>
              <ObservabilityAuditWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/observability/health" element={
            <ProtectedRoute>
              <ComingSoon title="System Health" description="Comprehensive system health monitoring" />
            </ProtectedRoute>
          } />

          {/* Cryptographic Verification Routes - Agent 10 */}
          <Route path="/velocity/crypto/dashboard" element={
            <ProtectedRoute>
              <CryptographicDashboardWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/crypto/evidence" element={
            <ProtectedRoute>
              <EvidenceIntegrityWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/crypto/trust-score" element={
            <ProtectedRoute>
              <TrustScoreProofWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/crypto/ai-verification" element={
            <ProtectedRoute>
              <AIVerificationWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/crypto/credentials" element={
            <ProtectedRoute>
              <CredentialVerificationWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/crypto/blockchain" element={
            <ProtectedRoute>
              <BlockchainExplorerWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/crypto/vtp" element={
            <ProtectedRoute>
              <VTPSmartContractsWrapper />
            </ProtectedRoute>
          } />
          <Route path="/velocity/crypto/analytics" element={
            <ProtectedRoute>
              <CryptographicAnalyticsWrapper />
            </ProtectedRoute>
          } />
          
          {/* Other Routes */}
          <Route path="/velocity/analytics" element={
            <ProtectedRoute>
              <ComingSoon title="Analytics" />
            </ProtectedRoute>
          } />
          <Route path="/velocity/workflows" element={
            <ProtectedRoute>
          ...
          {/* Fallback */}
          <Route path="/*" element={<Navigate to="/velocity" />} />
        </Routes>
      </Router>
    </VelocityProvider>
  );
