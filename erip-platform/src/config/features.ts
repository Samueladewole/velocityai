...
export const FEATURES = {
  ...
  SHOW_FULL_ERIP: import.meta.env.VITE_SHOW_FULL_ERIP === 'true',
  VELOCITY_ONLY: import.meta.env.VITE_VELOCITY_ONLY !== 'false', // Default to Velocity-only
  
  // Domain redirects
  REDIRECT_TO_VELOCITY: import.meta.env.VITE_REDIRECT_TO_VELOCITY !== 'false',
  
  // Individual ERIP component flags (all hidden by default)
  SHOW_PRISM: import.meta.env.VITE_SHOW_PRISM === 'true',
  SHOW_COMPASS: import.meta.env.VITE_SHOW_COMPASS === 'true', 
  SHOW_ATLAS: import.meta.env.VITE_SHOW_ATLAS === 'true',
  SHOW_NEXUS: import.meta.env.VITE_SHOW_NEXUS === 'true',
  SHOW_BEACON: import.meta.env.VITE_SHOW_BEACON === 'true',
  SHOW_CIPHER: import.meta.env.VITE_SHOW_CIPHER === 'true',
  SHOW_CLEARANCE: import.meta.env.VITE_SHOW_CLEARANCE === 'true',
  SHOW_PULSE: import.meta.env.VITE_SHOW_PULSE === 'true',
  SHOW_SHEETS: import.meta.env.VITE_SHOW_SHEETS === 'true',
  ...
  // Navigation flags
  SHOW_PLATFORM_NAV: import.meta.env.VITE_SHOW_PLATFORM_NAV === 'true',
  SHOW_SOLUTIONS_NAV: import.meta.env.VITE_SHOW_SOLUTIONS_NAV === 'true',
  SHOW_TOOLS_NAV: import.meta.env.VITE_SHOW_TOOLS_NAV === 'true',
