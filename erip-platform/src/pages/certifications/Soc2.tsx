      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Soc2 Certification</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Learn about our Soc2 compliance and certification status.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">Soc2 Compliant</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <p className="text-blue-800 text-sm">
                  Our Soc2 certification demonstrates our commitment to maintaining 
