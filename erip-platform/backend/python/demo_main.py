"""
ERIP Demo Backend - Simplified version for customer demonstrations
...
app = FastAPI(
    title="ERIP Demo Backend",
    description="Enterprise Risk Intelligence Platform - Demo API",
    version="1.6.0"
)
...
def generate_security_findings(count: int = 5) -> List[SecurityFinding]:
    ...
    findings_data = [
        {
            ...
            "description": "Production S3 bucket 'company-data-prod' has public read access enabled, exposing sensitive customer data",
            "severity": "CRITICAL",
            "affected_resources": ["s3://company-data-prod", "s3://backup-bucket-2024"],
            "risk_score": 9.2,
            "remediation_steps": [
        ...
        },
        {
            ...
            "description": "Production PostgreSQL database instance is publicly accessible from the internet",
            "severity": "CRITICAL", 
        ...
        },
        {
            ...
            "description": "EC2 instances running with overly permissive IAM roles including admin access",
            "severity": "HIGH",
        ...
        },
        {
            ...
            "description": "Multiple EBS volumes containing sensitive data are not encrypted",
            "severity": "MEDIUM",
        ...
        },
        {
            ...
            "description": "Security group allows SSH access from 0.0.0.0/0 (anywhere on the internet)",
            "severity": "HIGH",
    ...
    for i in range(min(count, len(findings_data))):
        ...
        results.append(SecurityFinding(
            ...
            discovered_at=datetime.utcnow() - timedelta(hours=random.randint(1, 72))
        ))
    ...
    risk_scenarios = [
        {
            ...
            "business_impact": "Potential $2.3M in regulatory fines, customer churn, and reputation damage"
        },
        {
            ...
            "business_impact": "Estimated $4.1M in downtime, data recovery, and ransom payments"
        },
        {
            ...
            "business_impact": "Potential $1.8M in IP theft and competitive intelligence loss"
        }
    ]
...
def generate_financial_metrics() -> List[FinancialMetric]:
    ...
    metrics = [
        {"name": "Total Risk Exposure", "value": 7.2, "currency": "M_USD", "trend": "decreasing"},
        {"name": "Security Investment ROI", "value": 245.0, "currency": "PERCENT", "trend": "increasing"},
        {"name": "Compliance Cost Savings", "value": 1.8, "currency": "M_USD", "trend": "increasing"},
        {"name": "Mean Time to Remediation", "value": 4.2, "currency": "DAYS", "trend": "decreasing"},
        {"name": "Security Score", "value": 8.7, "currency": "SCORE", "trend": "increasing"},
    ]
...
async def atlas_health():
    ...
    return {"status": "healthy", "component": "ATLAS Security Engine", "version": "1.6.0"}
...
async def run_security_assessment(assessment_request: Dict[str, Any]):
    ...
    overall_score = 10.0 - (sum(f.risk_score for f in findings) / len(findings))
...
async def prism_health():
    ...
    return {"status": "healthy", "component": "PRISM Risk Quantification", "version": "1.6.0"}
...
async def run_monte_carlo_analysis(analysis_request: Dict[str, Any]):
    ...
    for confidence in confidence_levels:
        ...
        base_var = sum(r.risk_score * r.mitigation_cost for r in risk_analyses) / 1000000
        var_results[f"var_{int(confidence*100)}"] = round(base_var * confidence, 2)
    ...
    return {
        ...
        "expected_loss": round(sum(r.probability * r.mitigation_cost for r in risk_analyses), 0),
        "total_risk_exposure": round(sum(r.risk_score * r.mitigation_cost for r in risk_analyses) / 1000000, 2),
        "recommendations": [
...
async def financial_intelligence_health():
    ...
    return {"status": "healthy", "component": "Financial Intelligence Platform", "version": "1.6.0"}
...
async def compass_health():
    ...
    return {"status": "healthy", "component": "COMPASS Regulatory Intelligence", "version": "1.6.0"}
    ...
    gaps = [
        {
            ...
            "description": "Formal change management procedures are not fully documented for all system modifications",
            "severity": "Medium",
        ...
        },
        {
            ...
            "description": "Privileged access is not regularly reviewed and some accounts have excessive permissions",
            "severity": "High",
...
if __name__ == "__main__":
    ...
    print("   • http://localhost:8001/financial-intelligence/* - Financial metrics APIs")
